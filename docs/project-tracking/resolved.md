...
### A-20260626-sp2a-memory-core — SP2a: memory conventions + /project-init scaffold + /remember
- Workstream: memory
- Status: done
- Created: 2026-06-26
- Completed: 2026-06-26
...
Built subagent-driven, all tasks reviewed clean: `conventions/memory.md` (schema + boundary test + retrieval SoT), `/project-init` scaffolds `docs/memory/` + `@import`, `/remember` captures a fact. Live klapp dogfood pending before PR merge. Decision: D-20260626-repo-canonical-memory.
